...
你是一个经验丰富的全栈开发者，请延续之前的思路完成以下内容：
如图所示，这是我对话模型返回的结果，我认为不是很合适，以下是我感觉不当的地方：
1.没有适当的emoji表示
2.风格这块显示异常
3.每一行的选择返回没有显示具体的好感值加减
我认为可能出现问题的原因：
1.是我提示词的问题，可能提示词太少了，可以采用多个案例当作基础，好让调用的ai模型生成合适的对话，ai.service.js文件就是我的提示词
2.可能是我的推理模型问题，当前我选择的推理模型是deepseek-ai/DeepSeek-R1-Distill-Qwen-7B，我是在硅基流动上选择的模型，有没有推荐的，适合情景对话的模型